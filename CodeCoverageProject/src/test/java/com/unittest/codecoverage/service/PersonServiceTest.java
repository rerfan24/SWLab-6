...
public class PersonServiceTest {
	...
	@Test
	void assertingPersonFirstConstructorException_thenThrown() {
		Person person = null;
		Throwable exception = (person == null ? assertThrows(
				PersonException.class,
				() -> {
					throw new PersonException("Person Creation is not OK");
				}
		): null);
		assertEquals("Person Creation is not OK", exception.getMessage());
	}
